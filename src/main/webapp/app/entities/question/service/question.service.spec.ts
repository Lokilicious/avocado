  ...
  describe('Service methods', () => {
    ...
    describe('addQuestionToCollectionIfMissing', () => {
      it('should add a Question to an empty array', () => {
        const question: IQuestion = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      ...
      it("should add a Question to an array that doesn't contain it", () => {
        const question: IQuestion = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
        const questionCollection: IQuestion[] = [{ id: '1361f429-3817-4123-8ee3-fdf8943310b2' }];
        expectedResult = service.addQuestionToCollectionIfMissing(questionCollection, question);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(question);
      });
      ...
      it('should add only unique Question to an array', () => {
        const questionArray: IQuestion[] = [
          ...
          { id: '1361f429-3817-4123-8ee3-fdf8943310b2' },
          { id: '4f44cfb7-fd02-4539-9fef-c26d31b8188a' },
        ];
        const questionCollection: IQuestion[] = [{ id: '9fec3727-3421-4967-b213-ba36557ca194' }];
      ...
      it('should accept varargs', () => {
        const question: IQuestion = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
        const question2: IQuestion = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
