...
describe('Answer routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IAnswer returned by find', () => {
      ...
      expect(resultAnswer).toEqual({ id: '9fec3727-3421-4967-b213-ba36557ca194' });
    });
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Answer })));
      mockActivatedRouteSnapshot.params = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
